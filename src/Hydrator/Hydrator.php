...
use DjinORM\Djin\Hydrator\Mappers\NestedMapperInterface;
...
class Hydrator
{
    ...
    {
        return $this->getScheme()[$property] ?? null;
    }
    ...
    protected function getSchemeRecursive(string $prefix, Hydrator $mappersHandler)
    {
        $map = [];
